...
LABEL org.opencontainers.image.source https://github.com/cccerith/containerbase
LABEL org.opencontainers.image.description "Development Container Base Image"
...
RUN groupadd -g $USER_GID $USERNAME && \
    useradd -s /bin/zsh -m -d /home/cccerith -u $USER_UID -g $USER_GID $USERNAME && \
...
COPY --chown=cccerith:cccerith zshrc.zsh /home/cccerith/.zshrc
COPY --chown=cccerith:cccerith zsh-aliases.zsh /home/cccerith/.zsh-aliases.zsh
COPY --chown=cccerith:cccerith p10k.zsh /home/cccerith/.p10k.zsh
...
RUN chmod u+rwx,g+rx,o+rx \
    ...
    mkdir /home/cccerith/.docker /home/cccerith/.kube && \
    chown ${USER_UID}:${USER_GID} /home/cccerith/.docker /home/cccerith/.kube && \
